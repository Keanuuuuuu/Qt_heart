...
void TcpServer::on_startBtn_clicked()
{
    ...
    // 首先要监听客户端的连接
    if(!tcpServer->listen(QHostAddress::Any,8000))// 监听IPv4和IPv6接口
    {
...
//void TcpServer::on_TcpServer_iconSizeChanged(const QSize &iconSize)
//{

//}


void TcpServer::on_closeButton_triggered(QAction *arg1)
{

}


void TcpServer::on_startBtn_clicked(bool checked)
{
